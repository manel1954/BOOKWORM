...
sed -i "4c Exec=sh -c 'cd /home/pi/BOOKWROM; lxterminal --geometry=72x8 -e sudo sh ejecutar_dstarrepeater.sh; sudo dstarrepeater & sudo ircddbgateway -gui'" /home/pi/Abrir_dstarrepeater.desktop
...
sed -i "4cExec=sh -c 'cd /home/pi/BOOKWROM; lxterminal --geometry=72x8 -e sudo sh ejecutar_ircDDB.sh; sudo ircddbgateway -gui'" /home/pi/Abrir_ircDDB.desktop
