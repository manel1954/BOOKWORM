...
sed -i "5c Icon=/home/pi/$SCRIPTS_version/ICO_DMRPLUS_ON.png" /home/pi/Abrir_autoarranques.desktop
sudo sed -i "10c Name[es_ES]=Cerrar AUTOARRANQUE" /home/pi/Abrir_autoarranques.desktop
