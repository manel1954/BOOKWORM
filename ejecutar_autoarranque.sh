...
sed -i "7c Icon=/home/pi/$SCRIPTS_version/ICO_AUTOARRANQUE.png" /home/pi/Abrir_autoarranque.desktop
sed -i "11c Name[es_ES]=Cerrar AUTOARRANQUE" /home/pi/Abrir_autoarranque.desktop
